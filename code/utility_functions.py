...
#     print(words)
#     res=""
#     if spell.correction(words[0]):
#         res += spell.correction(words[0])
#     else:
#         res +=  words[0]
#     for i in range(1,len(words)):
#         if  spell.correction(words[i]):
#             res+=' '+spell.correction(words[i])
#         else:
#             res+=' '+words[i]
#     return res
